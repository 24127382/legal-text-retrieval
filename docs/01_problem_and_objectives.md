...
- Executable data/retrieval/modeling implementation thuộc standalone Kaggle notebooks; notebook-local assertions và run artifacts quyết định trạng thái validation, không phải sự tồn tại của một local `src/` package.
